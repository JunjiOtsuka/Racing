...
public class ProjectileHover : MonoBehaviour
{
    [HideInInspector]
	...
	MyPlayerInput input;						//A reference to the player's input					
	...
	void OnEnable()
	{
        ...
        m_AudioSource.Play();
		// m_AudioSource.clip = m_ProjectileClip;
		// AudioSource.PlayClipAtPoint(m_AudioSource.clip, transform.position, m_AudioSource.volume);
	}
	...
	void CalculatePropulsion()
	{
		...
		// if (PlayerInput.BrakeKey.IsPressed())
